...
- [MiniLLM: On-Policy Distillation of Large Language Models](https://arxiv.org/abs/2306.08543) *(2023)* — Reverse-KL framing for generative LMs; the paper that named the field. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/microsoft/LMOps/tree/main/minillm)
...
- [Speculative Knowledge Distillation](https://arxiv.org/abs/2410.11325) *(2024)* — Interleaved teacher/student sampling mitigates poor student rollout quality. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/google-research/google-research/tree/master/speculative_kd)
...
- [Trajectory-Refined Distillation](https://arxiv.org/abs/2606.08432) *(2026)* — Teacher revises the student's failed rollout within on-policy support before distilling, correcting prefix failure at the trajectory rather than token level. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/louieworth/trd)
...
- [DistiLLM: Towards Streamlined Distillation for Large Language Models](https://arxiv.org/abs/2402.03898) *(2024)* — Skew-KL divergence with adaptive off-policy use of student-generated outputs; foundational OPD objective formulation (ICML 2024). [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/jongwooko/distillm)
- [DistiLLM-2: A Contrastive Approach Boosts the Distillation of LLMs](https://arxiv.org/abs/2503.07067) *(2025)* — Contrastive extension of skew-KL; student-generated outputs collected per epoch. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/jongwooko/distillm-2)
...
- [ExOPD: Learning beyond Teacher via Generalized On-Policy Distillation with Reward Extrapolation](https://arxiv.org/abs/2602.12125) *(2026)* — Casts OPD as dense KL-constrained RL; reward scaling enables teacher-surpassing behavior. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/RUCBM/G-OPD)
...
- [Revisiting On-Policy Distillation — Empirical Failure Modes and Simple Fixes](https://arxiv.org/abs/2603.25562) *(2026)* — Truncated reverse-KL with teacher top-K support matching; fixes imbalanced signals and tokenizer mismatch. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/hhh675597/revisiting_opd)
...
- [HPD: Hybrid Policy Distillation for LLMs](https://arxiv.org/abs/2604.20244) *(2026)* — Unified reweighted-log-likelihood framework combining forward/reverse KL with off-policy and on-policy sampling. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/zwhong714/Hybrid-Policy-Distillation)
- [Uni-OPD: Unifying On-Policy Distillation with a Dual-Perspective Recipe](https://arxiv.org/abs/2605.03677) *(2026)* — Offline difficulty-aware and online correctness-aware data balancing with outcome-guided margin calibration. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/WenjinHou/Uni-OPD)
...
- [SDFT: Self-Distillation Enables Continual Learning](https://arxiv.org/abs/2601.19897) *(2026)* — Demonstration-conditioned self-teaching for continual learning with less forgetting. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/idanshen/Self-Distillation)
- [SDPO: Reinforcement Learning via Self-Distillation](https://arxiv.org/abs/2601.20802) *(2026)* — Converts textual feedback into dense self-teacher signals for RL-like training. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/lasgroup/SDPO)
- [Why Does Self-Distillation (Sometimes) Degrade the Reasoning Capability of LLMs?](https://arxiv.org/abs/2603.24472) *(2026)* — Traces failures to suppression of epistemic verbalization; task coverage determines whether conciseness helps. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/beanie00/self-distillation-analysis)
- [OPSDC: On-Policy Self-Distillation for Reasoning Compression](https://arxiv.org/abs/2603.05433) *(2026)* — Compresses verbose reasoning using concise privileged self-teachers. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/HJSang/CRISP_Reasoning_Compression)
...
- [COPSD: Crosslingual On-Policy Self-Distillation for Multilingual Reasoning](https://arxiv.org/abs/2605.09548) *(2026)* — Uses English translations and reference solutions as privileged teacher context for low-resource multilingual reasoning OPSD. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/cisnlp/COPSD)
...
- [SGSD: Skill-Conditioned Gated Self-Distillation for LLM Reasoning](https://arxiv.org/abs/2605.28791) *(2026)* — Skill-conditioned OPSD whose retrieved-skill teachers are outcome-validated before distillation, extending privileged self-distillation to unreliable experience-derived context. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/walawalagoose/SGSD)
...
- [DSKD: A Dual-Space Framework for General KD](https://arxiv.org/abs/2504.11426) *(2025)* — Unifies output spaces; supports on- and off-policy KD between any two LLMs. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/songmzhang/DSKDv2)
...
- [TSD-KD: Explain in Your Own Words](https://arxiv.org/abs/2603.13260) *(2026)* — Student proposes candidates, teacher reranks, selective token distillation. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/kmswin1/TSD-KD)
...
- [DDT: Towards On-Policy SFT via Distribution Discriminant Theory](https://arxiv.org/abs/2602.12222) *(2026)* — In-Distribution Finetuning and Hinted Decoding realign training data to the student's distribution. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/zhangmiaosen2000/Towards-On-Policy-SFT)
...
- [Multi-Token Prediction via Self-Distillation](https://arxiv.org/abs/2602.06019) *(2026)* — Online self-distillation for multi-token prediction and faster inference. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/jwkirchenbauer/mtp-lm)
...
- [LUFFY: Learning to Reason under Off-Policy Guidance](https://arxiv.org/abs/2504.14945) *(2025)* — Mixed-policy GRPO combining on-policy rollouts with off-policy teacher traces via regularized importance sampling. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/ElliottYan/LUFFY)
...
- [AlignDistil: Token-Level Language Model Alignment as Adaptive Policy Distillation](https://arxiv.org/abs/2503.02832) *(2025)* — Casts RLHF as token-level distillation by injecting DPO rewards (ACL 2025). [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/songmzhang/AlignDistil)
- [KEPO: Knowledge-Enhanced Preference Optimization for Reinforcement Learning with Reasoning](https://arxiv.org/abs/2602.00400) *(2026)* — Quality-gated OPD on high-quality trajectories plus knowledge-enhanced exploration via teacher hints. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/Corleno/KEPO)
...
- [LLM4Teach: Large Language Model as a Policy Teacher for Training RL Agents](https://arxiv.org/abs/2311.13373) *(2023)* — LLM teacher distills into small RL agent that surpasses teacher through environment interaction. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/ZJLAB-AMMI/LLM4Teach)
- [RPD: Refined Policy Distillation — From VLA Generalists to RL Experts](https://arxiv.org/abs/2503.05833) *(2025)* — Teacher VLA actions guide student during RL exploration; combines RL with behavioral cloning (IROS 2026). [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/Refined-Policy-Distillation/RPD)
- [π-Flow: Policy-Based Few-Step Generation via Imitation Distillation](https://arxiv.org/abs/2510.14974) *(2025)* — Imitation distillation aligns student flow-model trajectories with teacher under standard flow matching (ICLR 2026). [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/Lakonik/piFlow)
- [Step-Audio-R1 Technical Report](https://arxiv.org/abs/2511.15848) *(2025)* — Modality-Grounded Reasoning Distillation produces audio reasoning grounded in acoustic features. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/stepfun-ai/Step-Audio-R1)
...
- [Online Speculative Decoding](https://arxiv.org/abs/2310.07177) *(2023)* — Continuously updates draft on observed queries via KD; 1.42×-2.17× latency gains. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/LiuXiaoxuanPKU/OSD)
...
- [HASS: Learning Harmonized Representations for Speculative Sampling](https://arxiv.org/abs/2408.15766) *(2024)* — Harmonized objective and context distillation fixes train-decoding inconsistency. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/HArmonizedSS/HASS)
- [Falcon: Faster and Parallel Inference through Enhanced Semi-Autoregressive Drafting](https://arxiv.org/abs/2412.12639) *(2024)* — Coupled Sequential Glancing Distillation strengthens inter-token dependencies in semi-AR drafters. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/Bestpay-inc/Falcon)
...
- [EAGLE-3: Scaling up Inference Acceleration via Training-Time Test](https://arxiv.org/abs/2503.01840) *(2025)* — Direct token prediction with multi-layer feature fusion under on-policy training-time test; up to 6.5×. [![Code](https://img.shields.io/badge/Code-181717?style=flat&logo=github&logoColor=white)](https://github.com/SafeAILab/EAGLE)
